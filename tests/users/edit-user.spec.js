...
describe("[Functional Test] Edit user", () => {
  ...
  test.describe("When we edit a user", () => {
    test("Should the changes in the user we edited", async () => {
      ...
      await userPage.searchUser('EditedUser');
